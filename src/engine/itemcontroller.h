...
namespace engine
{
    ...
    {
        osg::BoundingBoxImpl<osg::Vec3i> distance;
    ...
    class ItemController
    {
        ...
        gsl::not_null<std::shared_ptr<render::Entity>> const m_sceneNode;
        gsl::not_null<osg::ref_ptr<osg::PositionAttitudeTransform>> const m_transform = new osg::PositionAttitudeTransform();
    ...
    public:
        ...
        osg::BoundingBoxImpl<osg::Vec3i> getBoundingBox() const;
        ...
        void applyPosition()
        {
            if(auto parent = m_position.room)
                m_transform->setPosition(m_position.position.toIrrlicht() - parent->position.toIrrlicht());
            else
                m_transform->setPosition(m_position.position.toIrrlicht());
        ...
        const std::shared_ptr<render::Entity>& getSceneNode() const noexcept
        {
            return m_sceneNode;
        }
    ...
    {
    public:
        DummyItemController(const gsl::not_null<level::Level*>& level, const std::shared_ptr<engine::MeshAnimationController>& dispatcher, const gsl::not_null<std::shared_ptr<render::Entity>>& sceneNode, const std::string& name, const gsl::not_null<const loader::Room*>& room, const gsl::not_null<loader::Item*>& item)
    ...
    {
    public:
        ItemController_55_Switch(const gsl::not_null<level::Level*>& level, const std::shared_ptr<engine::MeshAnimationController>& dispatcher, const gsl::not_null<std::shared_ptr<render::Entity>>& sceneNode, const std::string& name, const gsl::not_null<const loader::Room*>& room, const gsl::not_null<loader::Item*>& item)
    ...
    {
    public:
        ItemController_35_CollapsibleFloor(const gsl::not_null<level::Level*>& level, const std::shared_ptr<engine::MeshAnimationController>& dispatcher, const gsl::not_null<std::shared_ptr<render::Entity>>& sceneNode, const std::string& name, const gsl::not_null<const loader::Room*>& room, const gsl::not_null<loader::Item*>& item)
    ...
    {
    public:
        ItemController_41_TrapDoorUp(const gsl::not_null<level::Level*>& level, const std::shared_ptr<engine::MeshAnimationController>& dispatcher, const gsl::not_null<std::shared_ptr<render::Entity>>& sceneNode, const std::string& name, const gsl::not_null<const loader::Room*>& room, const gsl::not_null<loader::Item*>& item)
            : ItemController(level, dispatcher, sceneNode, name, room, item, true, 0x30)
        {
        }
        ...
        void patchCeiling(const core::TRCoordinates& pos, long& y) override
        {
            ...
            y = std::lround(getPosition().Y + core::QuarterSectorSize);
        }

    private:
        bool possiblyOnTrapdoor(const core::TRCoordinates& pos) const
        {
            auto sx = std::lround(std::floor(getPosition().X / core::SectorSize));
            auto sz = std::lround(std::floor(getPosition().Z / core::SectorSize));
            auto psx = pos.X / core::SectorSize;
            auto psz = pos.Z / core::SectorSize;
    ...
    {
    public:
        ItemController_TrapDoorDown(const gsl::not_null<level::Level*>& level, const std::shared_ptr<engine::MeshAnimationController>& dispatcher, const gsl::not_null<std::shared_ptr<render::Entity>>& sceneNode, const std::string& name, const gsl::not_null<const loader::Room*>& room, const gsl::not_null<loader::Item*>& item)
            : ItemController(level, dispatcher, sceneNode, name, room, item, true, 0x30)
        {
        }
    ...
    {
    public:
        ItemController_Door(const gsl::not_null<level::Level*>& level, const std::shared_ptr<engine::MeshAnimationController>& dispatcher, const gsl::not_null<std::shared_ptr<render::Entity>>& sceneNode, const std::string& name, const gsl::not_null<const loader::Room*>& room, const gsl::not_null<loader::Item*>& item)
            : ItemController(level, dispatcher, sceneNode, name, room, item, true, 0x30)
        {
        }
    ...
    {
    public:
        ItemController_Block(const gsl::not_null<level::Level*>& level, const std::shared_ptr<engine::MeshAnimationController>& dispatcher, const gsl::not_null<std::shared_ptr<render::Entity>>& sceneNode, const std::string& name, const gsl::not_null<const loader::Room*>& room, const gsl::not_null<loader::Item*>& item)
            : ItemController(level, dispatcher, sceneNode, name, room, item, true, 0x34)
        {
            if(!m_flags2_04_ready || !m_flags2_02_toggledOn)
    ...
    {
    public:
        ItemController_TallBlock(const gsl::not_null<level::Level*>& level, const std::shared_ptr<engine::MeshAnimationController>& dispatcher, const gsl::not_null<std::shared_ptr<render::Entity>>& sceneNode, const std::string& name, const gsl::not_null<const loader::Room*>& room, const gsl::not_null<loader::Item*>& item)
            : ItemController(level, dispatcher, sceneNode, name, room, item, true, 0x34)
        {
    ...
    {
    public:
        ItemController_68_BridgeFlat(const gsl::not_null<level::Level*>& level, const std::shared_ptr<engine::MeshAnimationController>& dispatcher, const gsl::not_null<std::shared_ptr<render::Entity>>& sceneNode, const std::string& name, const gsl::not_null<const loader::Room*>& room, const gsl::not_null<loader::Item*>& item)
            : ItemController(level, dispatcher, sceneNode, name, room, item, false, 0)
        {
        }
    ...
    private:
        const int m_div;
    public:
        ItemController_SlopedBridge(const gsl::not_null<level::Level*>& level, const std::shared_ptr<engine::MeshAnimationController>& dispatcher, const gsl::not_null<std::shared_ptr<render::Entity>>& sceneNode, const std::string& name, const gsl::not_null<const loader::Room*>& room, const gsl::not_null<loader::Item*>& item, int div)
            : ItemController(level, dispatcher, sceneNode, name, room, item, false, 0)
            , m_div(div)
        {
        }
    ...
    private:
        long getBridgeSlopeHeight(const core::TRCoordinates& pos) const
        {
            ...
            {
            case core::Axis::PosZ:
                return core::SectorSize - 1 - pos.X % core::SectorSize;
            case core::Axis::PosX:
                return pos.Z % core::SectorSize;
            case core::Axis::NegZ:
                return pos.X % core::SectorSize;
            case core::Axis::NegX:
                return core::SectorSize - 1 - pos.Z % core::SectorSize;
            default:
                return 0;
            }
        }
    ...
    {
    public:
        ItemController_69_BridgeSlope1(const gsl::not_null<level::Level*>& level, const std::shared_ptr<engine::MeshAnimationController>& dispatcher, const gsl::not_null<std::shared_ptr<render::Entity>>& sceneNode, const std::string& name, const gsl::not_null<const loader::Room*>& room, const gsl::not_null<loader::Item*>& item)
    ...
    {
    public:
        ItemController_70_BridgeSlope2(const gsl::not_null<level::Level*>& level, const std::shared_ptr<engine::MeshAnimationController>& dispatcher, const gsl::not_null<std::shared_ptr<render::Entity>>& sceneNode, const std::string& name, const gsl::not_null<const loader::Room*>& room, const gsl::not_null<loader::Item*>& item)
    ...
    {
    public:
        ItemController_SwingingBlade(const gsl::not_null<level::Level*>& level, const std::shared_ptr<engine::MeshAnimationController>& dispatcher, const gsl::not_null<std::shared_ptr<render::Entity>>& sceneNode, const std::string& name, const gsl::not_null<const loader::Room*>& room, const gsl::not_null<loader::Item*>& item)
            : ItemController(level, dispatcher, sceneNode, name, room, item, true, 0x30)
        {
        }
